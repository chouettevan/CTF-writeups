...
## Introduction
This challenge includes a [binary](assets/blackjack) , 
[source code](assets/blackjack.c) , the [loader](assets/ld-linux-x86-64.so.2) and [libc](assets/libc.so.6) binaries.
